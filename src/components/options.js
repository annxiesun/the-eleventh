                ...
                <div className="options-container">
                    <span className="">
                        ...
                        <div className="month-choose">
                            ...
                            <button className="check-opt" onClick={this.props.checkToday}>
                            ...
                            <button class="check-opt" onClick={this.props.checkAll}>
                            ...
                            <button class="check-opt" onClick={this.props.clearAll}>
